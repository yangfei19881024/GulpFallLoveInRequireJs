...
define(['jquery', 'app/models/aboutModel', 'bootstrap', 'app/util/index'], function ($, model) {
  'use strict';
  ...
  $(function () {
    ...
    $('.progress-bar').css({ 'width': percent }).attr('aria-valuenow', percent.substr(0, percent.length - 1));
